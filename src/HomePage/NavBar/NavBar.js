...
import {updatesearchMovie } from "../../Store/Slice.js"
...
export default function PrimarySearchAppBar(props) {
  ...
  const stateSelect = useSelector(({ data }) => data);
  let gstateUserName=stateSelect.googleUserName || "Sign in";
  console.log(gstateUserName);
        ...
        >
          <Toolbar>
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              <span className="place-selected">Chennai</span>
              <Button
                variant="contained"
